...
public class GestiondesTickets {
    ...
    private void addTicket() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("AjouterTicket.fxml"));
            if (loader.getLocation() == null) {
                throw new IOException("Ressource /AjouterTicket.fxml introuvable");
            }
    ...
    private void editTicket() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("ModifierTicket.fxml"));
            if (loader.getLocation() == null) {
                throw new IOException("Ressource /ModifierTicket.fxml introuvable");
            }
            System.out.println("Configuration du ControllerFactory...");
            Connection conn = DBconnection.getInstance().getConn();
            if (conn == null) {
    ...
    private void deleteTicket() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("SupprimerTicket.fxml"));
            if (loader.getLocation() == null) {
                throw new IOException("Ressource SupprimerTicket.fxml introuvable");
            }
            Parent root = loader.load();
    ...
    private void displayTicket() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("AfficherTicket.fxml"));
            if (loader.getLocation() == null) {
                throw new IOException("Ressource AfficherTicket.fxml introuvable");
            }
            Parent root = loader.load();
