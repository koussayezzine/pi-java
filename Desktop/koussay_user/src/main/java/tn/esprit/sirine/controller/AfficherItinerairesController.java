...
import tn.esprit.sirine.utils.DataRefreshManager.DataRefreshListener;
import tn.esprit.sirine.utils.TransportAPI;
...
public class AfficherItinerairesController implements DataRefreshListener {
    ...
    public void initialize() {
        ...
        String[] resources = {
            "/tn/esprit/sirine/AjouterItineraire.fxml",
            "/tn/esprit/sirine/ajouteritineraire.fxml",
            "/tn/esprit/sirine/ModifierItineraire.fxml",
            "/tn/esprit/sirine/modifieritineraire.fxml",
            "/tn/esprit/sirine/SupprimerItineraire.fxml",
            "/tn/esprit/sirine/supprimeritineraire.fxml",
            "/tn/esprit/sirine/AfficherItineraires.fxml",
            "/tn/esprit/sirine/afficheritineraires.fxml"
        };
    ...
    public void goToAjouter(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/sirine/AjouterItineraire.fxml"));
    ...
    public void goToModifier(ActionEvent event) {
        ...
        try {
            ...
            URL url = getClass().getResource("/tn/esprit/sirine/ModifierItineraire.fxml");
            if (url == null) {
    ...
    public void goToSupprimer(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/sirine/SupprimerItineraire.fxml"));
            Parent root = loader.load();
    ...
    public void goBack(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/tn/esprit/sirine/DashboardW.fxml"));
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
