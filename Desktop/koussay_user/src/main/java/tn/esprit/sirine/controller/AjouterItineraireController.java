...
public class AjouterItineraireController implements Initializable {
    ...
    private void ajouterItineraire(ActionEvent event) {
        ...
        try {
            ...
            tn.esprit.sirine.utils.DataRefreshManager.getInstance().notifyDataChanged("itineraire");
    ...
    private void simpleGoBack(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/tn/esprit/sirine/AfficherItineraires.fxml"));
