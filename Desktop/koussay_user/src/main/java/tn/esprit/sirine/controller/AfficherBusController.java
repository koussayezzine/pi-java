...
public class AfficherBusController {
    ...
    private void handleAjouter(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/sirine/AjouterBus.fxml"));
    ...
    private void goToModifier(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/sirine/ModifierBus.fxml"));
            Parent root = loader.load();
    ...
    private void goToSupprimer(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/sirine/SupprimerBus.fxml"));
            Parent root = loader.load();
